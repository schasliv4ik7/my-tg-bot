...
def get_player_stats(match_id, side):
    """Анализирует последние 5 матчей игрока из реальной статистики SofaScore."""
...
def monitor_table_tennis():
    print("=== Трёхуровневый фильтр сигналов запущен ===")
    send_telegram_message(
        f"🤖 <b>Трёхуровневый фильтр успешно запущен на SofaScore!</b>\n\n"
        ...
        f"3️⃣ <b>Упущенный 1-й сет:</b> винрейт фаворита {MIN_WIN_RATE_FAV}%, стрик {MIN_STREAK_FAV}\n"
        f"📋 <b>Активные лиги:</b> Liga Pro, Setka Cup, TT Cup, TT Elite, Challenger Series"
    )
        ...
        try:
            ...
            if matches:
                ...
                for match in matches:
                    ...
                    # --- СЦЕНАРИЙ 3: УПУЩЕННЫЙ ПЕРВЫЙ СЕТ (Новый сигнал!) ---
                    if not signal_triggered:
                        # Игрок 1 упустил первый сет (Счет 0 : 1)
                        ...
                        # Игрок 2 упустил первый сет (Счет 1 : 0)
